    ...
    $(window).load(function () {
        ...
        jQuery('.scrollto a, a.scroll').click(function () {
            ...
            if ($('#top-nav').length != 0) {
                ...
                jQuery('html,body').stop().animate({scrollTop: jQuery("div" + id).offset().top}, 'slow');
            }
        ...
        /*-- Screenshot carousel --*/
        if (window_width >= 800) {
            var screenshot_width = 300;
        } //DESKTOP
        if (window_width <= 800 && window_width > 700) {
            var screenshot_width = 200;
        } //iPad
        if (window_width <= 700 && window_width > 500) {
            var screenshot_width = 245;
        } //iPhone5 Landscape
        if (window_width <= 500 && window_width > 425) {
            var screenshot_width = 195;
        } //iPhone4 Lanscape
        if (window_width <= 425 && window_width > 385) {
            var screenshot_width = 175;
        } //iPhone6 Plus Portait
        if (window_width <= 400) {
            var screenshot_width = 280;
        }
        ...
        if (window_width <= 1200 && window_width > 700) {
            var item_width = 225;
        }
        if (window_width <= 700 && window_width > 500) {
            var item_width = 250;
